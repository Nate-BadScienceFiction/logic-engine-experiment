> **Superseded; archived September 2026.** This describes the earlier engine as of April 9, 2026. Several architecture details are out of date. For the current engine see [ENGINE.md](../docs/ENGINE.md); for what changed, see [HISTORY.md](../docs/HISTORY.md).
...
This section provides in-depth explanations of key concepts. If you are new to logic programming or Event Calculus, start here. For a side-by-side comparison with SWI-Prolog, see [KB_ARCHITECTURE_VS_SWI_PROLOG.md](KB_ARCHITECTURE_VS_SWI_PROLOG-2026-04.md).
