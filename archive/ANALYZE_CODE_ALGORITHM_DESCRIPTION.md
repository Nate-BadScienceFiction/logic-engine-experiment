> **Archived September 2026.** This describes the code-analysis tool (v1.3, December 2025) that mapped the earlier engine's codebase for the agents. The data it produced and the interactive chart built from it were removed from this repository; the static charts are in [charts/](charts/).
